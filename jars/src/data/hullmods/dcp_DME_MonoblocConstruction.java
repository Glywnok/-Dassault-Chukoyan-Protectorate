...
//    }
    ...
    static
    {
        ...
        BLOCKED_HULLMODS.add("dcp_bbassault"); // Sneaky little bastards
        BLOCKED_HULLMODS.add("dcp_bbdefense"); // Every loophole you find, I'll stop up
        BLOCKED_HULLMODS.add("dcp_bbsupport"); // So prepare for an arms race if you wanna use this stuff.
    }
	...
	tooltip.addPara("%s " + getString("MonoblocDesc2"), padS, Misc.getHighlightColor(), "-", "50%");
        ...
        TooltipMakerAPI text = tooltip.beginImageWithText("graphics/DCP/icons/tooltip/hullmod_incompatible.png", 40);
