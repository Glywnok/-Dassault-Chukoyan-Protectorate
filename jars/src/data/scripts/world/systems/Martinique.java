...
public class Martinique {
	...
	public void generate(SectorAPI sector) {	
		...
		PlanetAPI martinique_star = system.initStar("martinique", // unique id for this star 
                ...
                PlanetAPI morningside = system.addPlanet("dcp_planet_morningside", martinique_star, "Morningside", "barren", 240, 50, 840, 40);
		...
		PlanetAPI valjean = system.addPlanet("dcp_planet_valjean", martinique_star, "Valjean", "dcp_aridbread", 0, 120, 2160, 80);
		...
		system.addRingBand(martinique_star, "misc", "rings_asteroids0", 256f, 1, Color.white, 256f, 3720, 125f, null, null);
                ...
                PlanetAPI cosette = system.addPlanet("dcp_planet_cosette", martinique_star, "Cosette", "barren-bombarded", 75, 40, 4200, 180);
		...
		system.addRingBand(martinique_star, "misc", "rings_ice0", 256f, 2, Color.white, 256f, 4600, 285f, null, null);
            ...
            MarketAPI novymirMarket = AddMarketplace.addMarketplace("dassault_mikoyan", indStation, null,
                ...
                PlanetAPI javert = system.addPlanet("dcp_planet_javert", martinique_star, "Javert", "cryovolcanic", 135, 120, 6000, 270);
