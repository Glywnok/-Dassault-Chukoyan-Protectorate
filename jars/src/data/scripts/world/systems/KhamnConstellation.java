...
public class KhamnConstellation {
   ...
   public void generate(SectorAPI sector) {
      ...
      SectorEntityToken khamn_buoy = system_khamn.addCustomEntity("khamn_nav_buoy", "Khamn Nav Buoy", "nav_buoy", "dcp_magellan_protectorate");
      ...
      MarketAPI pariyaMarket = AddMarketplace.addMarketplace("dcp_magellan_protectorate", pariya, (ArrayList)null, "Pariya", 3, new ArrayList(Arrays.asList("hot", "low_gravity", "no_atmosphere", "outpost", "population_3")), new ArrayList(Arrays.asList("spaceport", "heavybatteries", "population")), new ArrayList(Arrays.asList("black_market", "open_market", "storage")), 0.3F);
      ...
      SectorEntityToken annoreOrbital = system_khamn.addCustomEntity("dcp_magellan_annore_orbital", "Annore Orbital", "station_side04", "dcp_magellan_protectorate");
      ...
      SectorEntityToken sporeStation = system_khamn.addCustomEntity("dcp_magellan_sporeship", "Crucible Base", "station_sporeship_derelict", "dcp_magellan_protectorate");
      ...
      SectorEntityToken magella_array = system_khamn.addCustomEntity("magella_sensor_array", "Magella Array", "sensor_array", "dcp_magellan_protectorate");
      ...
      CampaignFleetAPI herdfleet_portobilo = MagicCampaign.createFleet("Port Obilo Herd", "dcp_magellan_theherd", "scavengerLarge", "HS Now You Get The Horns", "dcp_magellan_herdcarrier_std", (PersonAPI)null, (Map)null, 240, "dcp_magellan_theherd", 0.75F, (SectorEntityToken)null, FleetAssignment.ORBIT_AGGRESSIVE, pirStation, false, true);
      ...
      SectorEntityToken meetpointTuran = system_karic.addCustomEntity("dcp_magellan_station_meetpoint", "Meetpoint Turan", "station_side04", "dcp_magellan_independentmkt");
      ...
      SectorEntityToken valcaOrbital = system_karic.addCustomEntity("dcp_magellan_valca_orbital", "Valca Bastion", "station_side02", "dcp_magellan_protectorate");
      ...
      CampaignFleetAPI herdfleet_junk = MagicCampaign.createFleet("Calicheman Herd", "dcp_magellan_theherd", "scavengerMedium", "HS Eat A Lotta Meat", "dcp_magellan_herdcarrier_std", (PersonAPI)null, (Map)null, 180, "dcp_magellan_theherd", 0.75F, (SectorEntityToken)null, FleetAssignment.ORBIT_AGGRESSIVE, calicheman, false, true);
      ...
      CampaignFleetAPI herdfleet_junk2 = MagicCampaign.createFleet("Calicheman Subherd", "dcp_magellan_theherd", "patrolSmall", "HS Big Moo II", "dcp_magellan_linedestroyer_theherd_support", (PersonAPI)null, (Map)null, 75, "dcp_magellan_theherd", 0.75F, (SectorEntityToken)null, FleetAssignment.ORBIT_PASSIVE, calicheman, false, true);
      ...
      CampaignFleetAPI herdfleet_junk3 = MagicCampaign.createFleet("Calicheman Subherd", "dcp_magellan_theherd", "patrolSmall", "HS Cow Tools IV", "dcp_magellan_linedestroyer_theherd_fighter", (PersonAPI)null, (Map)null, 75, "dcp_magellan_theherd", 0.75F, (SectorEntityToken)null, FleetAssignment.ORBIT_PASSIVE, calicheman, false, true);
      ...
      SectorEntityToken gardenRelay = system_three.addCustomEntity("dcp_magellan_garden_relay", "Rosebriar Relay", "comm_relay_makeshift", "dcp_magellan_leveller");
      gardenRelay.setCircularOrbitPointingDown(three_star, 30.0F, 1450.0F, 150.0F);
      SectorEntityToken oldLevellerStation = system_three.addCustomEntity("dcp_magellan_rosebriar_station", "Rosebriar Station", "station_side03", "dcp_magellan_leveller");
      ...
      CampaignFleetAPI levellerwarfleet = MagicCampaign.createFleet("Rosebriar Guard Fleet", "dcp_magellan_leveller", "taskForce", "LVS Vanguard", "dcp_magellan_skipjack_leveller_std", (PersonAPI)null, (Map)null, 180, "dcp_magellan_leveller", 2.0F, (SectorEntityToken)null, FleetAssignment.PATROL_SYSTEM, oldLevellerStation, true, true);
      ...
      CampaignFleetAPI levellerpatrolfleet_1 = MagicCampaign.createFleet("Rosebriar Patrol Group", "dcp_magellan_leveller", "taskForce", "LVS Knight", "dcp_magellan_supportdestroyer_leveller_turncoat", (PersonAPI)null, (Map)null, 60, "dcp_magellan_leveller", 1.5F, (SectorEntityToken)null, FleetAssignment.ORBIT_PASSIVE, oldLevellerStation, false, true);
      ...
      CampaignFleetAPI levellerpatrolfleet_2 = MagicCampaign.createFleet("Rosebriar Scout Group", "dcp_magellan_leveller", "taskForce", "LVS Swan", "dcp_magellan_patroldestroyer_leveller_turncoat", (PersonAPI)null, (Map)null, 36, "dcp_magellan_leveller", 1.5F, (SectorEntityToken)null, FleetAssignment.DEFEND_LOCATION, oldLevellerStation, false, true);
