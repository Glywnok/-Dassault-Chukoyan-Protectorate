...
public class Nikolaev
{
	...
	// SectorEntityToken nikolaev_nebula = Misc.addNebulaFromPNG("data/campaign/terrain/dcp_new_nebula.png", // I have no idea how to make this work properly! Something about the png file? Something about this file?
        ...
        system.addTag(dcp_Tags.THEME_DASSAULT_CAPITAL);
...
//	nikolaev_field2.setCircularOrbit(star, 0, 0, 80);
	...
	nikolaev_field1.setCircularOrbit(star, 0, 0, 120);
        ...
        PlanetAPI etincelle = system.addPlanet("dcp_planet_etincelle", star, "Étincelle", "lava", 150, 60, 1400, 45);
        ...
        PlanetAPI odessa = system.addPlanet("dcp_planet_odessa", star, "Odessa", "water", 270, 90, 2700, 60);
        odessa.setCustomDescriptionId("planet_odessa");
                ...
                SectorEntityToken odessaBase = system.addCustomEntity("dcp_odessabase", "Cousteau Base", "station_dme_small", "dassault_mikoyan");
                odessaBase.setCircularOrbitPointingDown(system.getEntityById("dcp_planet_odessa"), 75, 180, 36);
                odessaBase.setCustomDescriptionId("station_cousteaubase");
                odessaBase.setInteractionImage("illustrations", "cargo_loading");
                odessaBase.addTag("dcp_researchBase");
	...
	nikolaev_inner_buoy.setCircularOrbitPointingDown(star, 90, 2700, 60);
        ...
        PlanetAPI peremohy = system.addPlanet("dcp_planet_peremohy", star, "Peremohy", "terran-eccentric", 0, 200, 5200, 100);
        ...
        station.setCircularOrbitPointingDown(system.getEntityById("dcp_planet_peremohy"), 45, 420, 45);
	...
	// system.addEntity(jumpPoint2);
        ...
        // Stendhal system.
        PlanetAPI stendhal = system.addPlanet("dcp_planet_stendhal", star, "Stendhal", "gas_giant", 150, 500, 10800, 300);
        ...
        PlanetAPI stendhal1 = system.addPlanet("dcp_planet_rouge", stendhal, "Rouge", "lava_minor", 36, 90, 960, 45);
        ...
        PlanetAPI stendhal2 = system.addPlanet("dcp_planet_noir", stendhal, "Noir", "barren_castiron", 180, 120, 2100, 80);
        ...
        stendhal_tether1.setCustomDescriptionId("dcp_powertether");
        ...
        stendhal_tether2.setCustomDescriptionId("dcp_powertether");
        ...
        stendhal_tether3.setCustomDescriptionId("dcp_powertether");
        ...
        stendhal_tether4.setCustomDescriptionId("dcp_powertether");
        ...
        stendhal_tether5.setCustomDescriptionId("dcp_powertether");

        // Lavoisier Base
        SectorEntityToken labStation = system.addCustomEntity("nikolaev_lab", "Lavoisier Base", "station_dme_lab", "dassault_mikoyan");
        labStation.setCircularOrbitPointingDown(system.getEntityById("dcp_planet_noir"), 30, 300, 30);
        ...
        PlanetAPI juliette = system.addPlanet("dcp_planet_juliette", star, "Juliette", "barren-bombarded", 210, 40, 10850, 300);
		...
		0f); // days the field will keep generating glowing pieces
            ...
            addDerelict(system, juliette, "dcp_puddlejumper_mk1_std", ShipRecoverySpecial.ShipCondition.GOOD, 120f, (Math.random()<0.5), "independent");
            addDerelict(system, juliette, "dcp_sevastopol_mk1_std", ShipRecoverySpecial.ShipCondition.PRISTINE, 150f, true, "independent");
            addDerelict(system, juliette, "dcp_centaur_export", ShipRecoverySpecial.ShipCondition.AVERAGE, 210f, (Math.random()<0.5), "dassault_mikoyan");
            addDerelict(system, juliette, "dcp_naja_mk1_std", ShipRecoverySpecial.ShipCondition.AVERAGE, 240f, (Math.random()<0.5), "independent");
            addDerelict(system, juliette, "dcp_tereshkova_export", ShipRecoverySpecial.ShipCondition.BATTERED, 300f, (Math.random()<0.5), "dassault_mikoyan");
            addDerelict(system, juliette, "dcp_tunguska_6e_elite", ShipRecoverySpecial.ShipCondition.BATTERED, 360f, (Math.random()<0.5), "6eme_bureau");
            addDerelict(system, juliette, "dcp_samoyed_export", ShipRecoverySpecial.ShipCondition.BATTERED, 440f, true, "dassault_mikoyan");
            addDerelict(system, juliette, "dcp_zelenograd_explore", ShipRecoverySpecial.ShipCondition.WRECKED, 520f, false, "dassault_mikoyan");
	...
	stendhalL3_array.setCircularOrbitPointingDown(star, 330, 10800, 300);
        ...
        addDerelict(system, pirStation, "dcp_sevastopol_mk1_std", ShipRecoverySpecial.ShipCondition.GOOD, 200f, (Math.random()<0.5), "independent");
        addDerelict(system, pirStation, "dcp_naja_mk1_std", ShipRecoverySpecial.ShipCondition.BATTERED, 320f, true, "independent");
...
//        editor.clearArc(system.getLocation().x, system.getLocation().y, 0, system.getMaxRadiusInHyperspace()*1.25f, 0, 360, 0.25f);
    ...
    // {
        ...
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_baikal_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_leyte_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_leyte_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_mindanao_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_centaur_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_kormoran_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_samoyed_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_samoyed_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_sevastopol_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_sevastopol_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_tereshkova_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_starsylph_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_naja_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_stoat_Hull"));
        // cargo.getMothballedShips().addFleetMember(Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_stoat_Hull"));
    // }
