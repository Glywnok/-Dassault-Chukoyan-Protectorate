...
public class Nikolaev {
   public void generate(SectorAPI sector) {
      ...
      PlanetAPI etincelle = system.addPlanet("istl_planet_etincelle", star, "Étincelle", "lava", 150.0F, 60.0F, 1400.0F, 45.0F);
      ...
      PlanetAPI odessa = system.addPlanet("istl_planet_odessa", star, "Odessa", "water", 270.0F, 90.0F, 2700.0F, 60.0F);
      ...
      odessaBase.setCircularOrbitPointingDown(system.getEntityById("istl_planet_odessa"), 75.0F, 180.0F, 36.0F);
      ...
      PlanetAPI peremohy = system.addPlanet("istl_planet_peremohy", star, "Peremohy", "terran-eccentric", 0.0F, 200.0F, 5200.0F, 100.0F);
      ...
      station.setCircularOrbitPointingDown(system.getEntityById("istl_planet_peremohy"), 45.0F, 420.0F, 45.0F);
      ...
      PlanetAPI stendhal = system.addPlanet("istl_planet_stendhal", star, "Stendhal", "gas_giant", 150.0F, 500.0F, 10800.0F, 300.0F);
      ...
      PlanetAPI stendhal1 = system.addPlanet("istl_planet_rouge", stendhal, "Rouge", "lava_minor", 36.0F, 90.0F, 960.0F, 45.0F);
      ...
      PlanetAPI stendhal2 = system.addPlanet("istl_planet_noir", stendhal, "Noir", "barren_castiron", 180.0F, 120.0F, 2100.0F, 80.0F);
      ...
      labStation.setCircularOrbitPointingDown(system.getEntityById("istl_planet_noir"), 30.0F, 300.0F, 30.0F);
      ...
      PlanetAPI juliette = system.addPlanet("istl_planet_juliette", star, "Juliette", "barren-bombarded", 210.0F, 40.0F, 10850.0F, 300.0F);
      ...
      this.addDerelict(system, juliette, "istl_puddlejumper_mk1_std", ShipCondition.GOOD, 120.0F, Math.random() < 0.5D, "independent");
      this.addDerelict(system, juliette, "istl_sevastopol_mk1_std", ShipCondition.PRISTINE, 150.0F, true, "independent");
      this.addDerelict(system, juliette, "istl_centaur_export", ShipCondition.AVERAGE, 210.0F, Math.random() < 0.5D, "dassault_mikoyan");
      this.addDerelict(system, juliette, "istl_naja_mk1_std", ShipCondition.AVERAGE, 240.0F, Math.random() < 0.5D, "independent");
      this.addDerelict(system, juliette, "istl_tereshkova_export", ShipCondition.BATTERED, 300.0F, Math.random() < 0.5D, "dassault_mikoyan");
      this.addDerelict(system, juliette, "istl_tunguska_6e_elite", ShipCondition.BATTERED, 360.0F, Math.random() < 0.5D, "6eme_bureau");
      this.addDerelict(system, juliette, "istl_samoyed_export", ShipCondition.BATTERED, 440.0F, true, "dassault_mikoyan");
      this.addDerelict(system, juliette, "istl_zelenograd_explore", ShipCondition.WRECKED, 520.0F, false, "dassault_mikoyan");
      ...
      this.addDerelict(system, pirStation, "istl_sevastopol_mk1_std", ShipCondition.GOOD, 200.0F, Math.random() < 0.5D, "independent");
      this.addDerelict(system, pirStation, "istl_naja_mk1_std", ShipCondition.BATTERED, 320.0F, true, "independent");
