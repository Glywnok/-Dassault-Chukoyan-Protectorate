...
public class BessonConstellation {
   ...
   public void generate(SectorAPI sector) {
      ...
      StarAge dcp_DME_constellation_Age = StarAge.ANY;
      if (this.selector < 0.33F) {
         dcp_DME_constellation_Age = StarAge.YOUNG;
      }

      if (this.selector >= 0.33F && this.selector < 0.66F) {
         dcp_DME_constellation_Age = StarAge.AVERAGE;
      }

      if (this.selector >= 0.66F) {
         dcp_DME_constellation_Age = StarAge.OLD;
      }

      Constellation dcp_DME_constellation_Besson = new Constellation(ConstellationType.NORMAL, dcp_DME_constellation_Age);
      NameGenData data = new NameGenData("null", "null");
      NamePick constname = new NamePick(data, this.strings[this.nameSelector], "null");
      dcp_DME_constellation_Besson.setNamePick(constname);
      ...
      dcp_DME_constellation_Besson.getSystems().add(sector.getStarSystem("Alpha " + this.StarName));
      dcp_DME_constellation_Besson.getSystems().add(sector.getStarSystem("Beta " + this.StarName));
      dcp_DME_constellation_Besson.getSystems().add(sector.getStarSystem("Gamma " + this.StarName));
      dcp_DME_constellation_Besson.getSystems().add(sector.getStarSystem("Delta " + this.StarName));
      dcp_DME_constellation_Besson.getSystems().add(sector.getStarSystem("Epsilon " + this.StarName));
      sector.getStarSystem("Alpha " + this.StarName).setConstellation(dcp_DME_constellation_Besson);
      sector.getStarSystem("Beta " + this.StarName).setConstellation(dcp_DME_constellation_Besson);
      sector.getStarSystem("Gamma " + this.StarName).setConstellation(dcp_DME_constellation_Besson);
      sector.getStarSystem("Delta " + this.StarName).setConstellation(dcp_DME_constellation_Besson);
      sector.getStarSystem("Epsilon " + this.StarName).setConstellation(dcp_DME_constellation_Besson);
      system_besson.setBackgroundTextureFilename("graphics/backgrounds/background4.jpg");
      SectorEntityToken besson_nebula = Misc.addNebulaFromPNG("data/campaign/terrain/eos_nebula.png", 0.0F, 0.0F, system_besson, "terrain", "dcp_DME_nebula_sigma", 4, 4, StarAge.OLD);
      ...
      PlanetAPI lenze = system_besson.addPlanet("dcp_DME_planet_lenze", besson_star, "Lenze", "dcp_DME_sigmaworld", 145.0F, 150.0F, 5600.0F, -180.0F);
      ...
      lenze.getSpec().setShieldTexture(Global.getSettings().getSpriteName("industry", "dcp_DME_shield_texture"));
      ...
      lenze.getMarket().addCondition("dcp_DME_sigmarad");
      ...
      CustomCampaignEntityAPI beacon = system_besson.addCustomEntity((String)null, (String)null, "dcp_DME_bladebreaker_beacon", "neutral");
      beacon.setCircularOrbitPointingDown(lenze, 0.0F, 500.0F, -35.0F);
      beacon.getMemoryWithoutUpdate().set("$dcp_DME_lenzewarn", true);
      FleetMemberAPI member1 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_DME_bbsuperheavy_std");
      ...
      FleetMemberAPI member2 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_DME_bbsuperheavy_std");
      ...
      FleetMemberAPI member3 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_DME_bbsuperheavy_std");
      ...
      PlanetAPI marat1 = system_besson.addPlanet("dcp_DME_planet_marat1", marat, "Marat I", "cryovolcanic", 75.0F, 45.0F, 540.0F, 180.0F);
      ...
      PlanetAPI marat2 = system_besson.addPlanet("dcp_DME_planet_marat2", marat, "Marat II", "frozen", 135.0F, 90.0F, 1100.0F, 200.0F);
      ...
      PlanetAPI marat3 = system_besson.addPlanet("dcp_DME_planet_marat3", marat, "Marat III", "barren", 215.0F, 60.0F, 1560.0F, 220.0F);
      ...
      PlanetAPI lucille1 = system_besson.addPlanet("dcp_DME_planet_lucille1", besson_star_b, "Alpha " + this.StarName + " B I", "barren-bombarded", 360.0F * (float)Math.random(), 40.0F, 1280.0F, 140.0F);
      ...
      PlanetAPI lucille2 = system_besson.addPlanet("dcp_DME_planet_lucille2", besson_star_b, "Source", "terran-eccentric", 360.0F * (float)Math.random(), 60.0F, 1600.0F, 180.0F);
      ...
      SectorEntityToken stationDerelict1 = DerelictThemeGenerator.addSalvageEntity(system_besson, "dcp_DME_bladebreaker_mining", "blade_breakers");
      ...
      extraStation1Salvage.addCommodity("dcp_DME_sigma_matter2", 1.0F);
      extraStation1Salvage.addCommodity("dcp_DME_sigma_matter1", 3.0F);
      extraStation1Salvage.addCommodity("dcp_DME_sigma_matter3", 6.0F);
      ...
      this.addDerelict(system_besson, l5scrap, "dcp_DME_bbminerunner_std", ShipCondition.AVERAGE, 180.0F, true, "the_deserter");
      SectorEntityToken stationDerelict3 = DerelictThemeGenerator.addSalvageEntity(system_besson, "dcp_DME_bladebreaker_research", "blade_breakers");
      ...
      extraStation2Salvage.addCommodity("dcp_DME_sigma_matter1", 2.0F);
      BaseSalvageSpecial.addExtraSalvage(extraStation2Salvage, stationDerelict3.getMemoryWithoutUpdate(), -1.0F);
      system_besson.addPlanet("dcp_DME_planet_besson4", besson_star, "Alpha " + this.StarName + " IV", "barren", 360.0F * (float)Math.random(), 60.0F, 17600.0F, 480.0F);
      ...
      bessonHabitat.getMarket().getSubmarket("storage").getCargo().addSpecial(new SpecialItemData("dcp_DME_sigmatech_package", (String)null), 1.0F);
      bessonHabitat.getMarket().getSubmarket("storage").getCargo().addSpecial(new SpecialItemData("dcp_DME_deserter_package", (String)null), 1.0F);
      bessonHabitat.getMarket().getSubmarket("storage").getCargo().addSpecial(new SpecialItemData("dcp_DME_bladewood_package", (String)null), 1.0F);
      ...
      StarSystemGenerator.addSystemwideNebula(system_two, dcp_DME_constellation_Age);
      FleetMemberAPI member4 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_DME_guardian_turret_std");
      ...
      this.addDerelict(system_two, two_star, "dcp_DME_curse_proto_test", ShipCondition.GOOD, radius_curse, true, "the_deserter");
      this.addDerelict(system_two, two_star, "dcp_DME_imp_proto_test", ShipCondition.BATTERED, radius_curse - 100.0F, true, "the_deserter");
      this.addDerelict(system_two, two_star, "starliner_Standard", ShipCondition.GOOD, radius_curse + 75.0F, true, "independent");
      this.addDerelict(system_two, two_star, "dcp_DME_puddlejumper_mk1_std", ShipCondition.WRECKED, radius_curse - 75.0F, false, "independent");
      ...
      PlanetAPI laureline = system_two.addPlanet("dcp_DME_planet_laureline", two_star, "Laureline", "jungle", 300.0F, 120.0F, 6400.0F, 210.0F);
      ...
      extraStation3Salvage.addCommodity("dcp_DME_sigma_matter3", 3.0F);
      ...
      StarSystemGenerator.addOrbitingEntities(system_two, two_star, dcp_DME_constellation_Age, 3, 5, 8000.0F, 0, true);
      ...
      StarSystemGenerator.addSystemwideNebula(system_three, dcp_DME_constellation_Age);
      FleetMemberAPI member5 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_DME_guardian_turret_std");
      ...
      StarSystemGenerator.addOrbitingEntities(system_three, three_star, dcp_DME_constellation_Age, 4, 6, 2100.0F, 0, true);
      ...
      StarSystemGenerator.addSystemwideNebula(system_four, dcp_DME_constellation_Age);
      system_four.addRingBand(four_star, "misc", "dcp_DME_blankring", 256.0F, 0, Color.BLACK, 2160.0F, 1900.0F, 69.0F, "ring", "Delta " + this.StarName + " Disk");
      ...
      SectorEntityToken stationMining1 = DerelictThemeGenerator.addSalvageEntity(system_four, "dcp_DME_bladebreaker_mining", "blade_breakers");
      ...
      extraMining1Salvage.addCommodity("dcp_DME_sigma_matter1", 2.0F);
      extraMining1Salvage.addCommodity("dcp_DME_sigma_matter3", 5.0F);
      BaseSalvageSpecial.addExtraSalvage(extraMining1Salvage, stationMining1.getMemoryWithoutUpdate(), -1.0F);
      FleetMemberAPI member6 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_DME_guardian_turret_std");
      ...
      StarSystemGenerator.addOrbitingEntities(system_four, four_star, dcp_DME_constellation_Age, 4, 5, 4000.0F, 0, true);
      ...
      StarSystemGenerator.addSystemwideNebula(system_five, dcp_DME_constellation_Age);
      FleetMemberAPI member7 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "dcp_DME_bbsuperheavy_dmg");
      ...
      PlanetAPI yod2 = system_five.addPlanet("dcp_DME_planet_yod2", five_star, "Dzerzhinsky", "gas_giant", 300.0F, 450.0F, 2800.0F, 300.0F);
      ...
      PlanetAPI yod2a = system_five.addPlanet("dcp_DME_planet_yod2a", yod2, "Dzerzhinsky A", "barren", 180.0F, 30.0F, 660.0F, 50.0F);
      ...
      SectorEntityToken stationDerelict4 = DerelictThemeGenerator.addSalvageEntity(system_five, "dcp_DME_bladebreaker_research", "blade_breakers");
      ...
      PlanetAPI yod2b = system_five.addPlanet("dcp_DME_planet_yod2b", yod2, "Dzerzhinsky B", "barren-desert", 360.0F * (float)Math.random(), 75.0F, 900.0F, 90.0F);
      ...
      this.addDerelict(system_five, five_star, "dcp_DME_stormkestrel_proto_test", ShipCondition.GOOD, radius_sparrowhawk, true, "the_deserter");
      this.addDerelict(system_five, five_star, "dcp_DME_imp_proto_test", ShipCondition.AVERAGE, radius_sparrowhawk - 100.0F, true, "the_deserter");
      this.addDerelict(system_five, five_star, "dcp_DME_imp_proto_test", ShipCondition.WRECKED, radius_sparrowhawk + 125.0F, true, "the_deserter");
      this.addDerelict(system_five, five_star, "dcp_DME_imp_proto_test", ShipCondition.BATTERED, radius_sparrowhawk + 50.0F, true, "the_deserter");
      ...
      this.addDerelict(system_five, five_star, "dcp_DME_sevastopol_mk1_std", ShipCondition.BATTERED, radius_sparrowhawk + 250.0F, false, "independent");
      ...
      this.addDerelict(system_five, five_star, "dcp_DME_puddlejumper_mk1_std", ShipCondition.BATTERED, radius_sparrowhawk + 75.0F, true, "independent");
      this.addDerelict(system_five, five_star, "dcp_DME_puddlejumper_mk1_std", ShipCondition.AVERAGE, radius_sparrowhawk + 25.0F, false, "independent");
      PlanetAPI yod3 = system_five.addPlanet("dcp_DME_planet_yod3", five_star, "Chernov", "lava_minor", 120.0F, 200.0F, 5200.0F, 400.0F);
      ...
      PlanetAPI yod3shell = system_five.addPlanet("dcp_DME_planet_yod3shell", five_star, "Artificial Toposphere", "dcp_DME_dysonshell", 120.0F, 240.0F, 5200.0F, 400.0F);
      ...
      yod3shell.getSpec().setShieldTexture(Global.getSettings().getSpriteName("industry", "dcp_DME_dysonshield"));
      ...
      PlanetAPI yod3a = system_five.addPlanet("dcp_DME_planet_yod3a", yod3, "Chervy", "barren_castiron", 360.0F * (float)Math.random(), 45.0F, 400.0F, 60.0F);
      ...
      StarSystemGenerator.addOrbitingEntities(system_five, five_star, dcp_DME_constellation_Age, 3, 5, 6000.0F, 0, true);
