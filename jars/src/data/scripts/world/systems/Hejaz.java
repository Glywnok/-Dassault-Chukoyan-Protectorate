...
public class Hejaz {
	...
	public void generate(SectorAPI sector) {	
		...
		system.setLightColor(new Color(240, 225, 200)); // light color in entire system, affects all entities
                ...
                //Add mod tags.
                system.addTag(dcp_Tags.THEME_BREAKER_NO_FLEETS);
		...
		system.addRingBand(hejaz_star, "misc", "rings_dust0", 256f, 1, Color.white, 256f, 2300, 245f, null, null);
                ...
                addDerelict(system, hejaz_star, "dcp_tereshkova_export", ShipRecoverySpecial.ShipCondition.GOOD, 2250f, true);
		...
		system.addRingBand(hejaz_star, "misc", "rings_ice0", 256f, 2, Color.white, 256f, 3300, 300f, null, null);
                ...
                PlanetAPI qarib = system.addPlanet("dcp_planet_qarib", hejaz_star, "Qarib", "barren-desert", 240, 75, 4000, 180f);
		...
		qarib.applySpecChanges();
			...
			system.addEntity(jumpPoint1);
                ...
                system.addRingBand(hejaz_star, "misc", "rings_dust0", 256f, 3, Color.white, 256f, 4800, 300f, Terrain.RING, "Hejaz Dust Band");
                    ...
                    SectorEntityToken stationDerelict1 = DerelictThemeGenerator.addSalvageEntity(system, dcp_Entities.ORBITAL_HABITAT_BREAKER, dcp_Factions.BREAKERS);
