 ...
 */
public class dcp_BreakerBeaconIntel extends WarningBeaconIntel {

    public dcp_BreakerBeaconIntel(SectorEntityToken beacon) {
        super(beacon);
    ...
    public void createSmallDescription(TooltipMakerAPI info, float width, float height) {
        ...
        Description desc = Global.getSettings().getDescription("dcp_bladebreaker_beacon", Type.CUSTOM);
	...
	public String getIcon() {
		if (isLow()) {
			return Global.getSettings().getSpriteName("intel", "dcp_hardenedbeacon_low");
		} else if (isMedium()) {
			return Global.getSettings().getSpriteName("intel", "dcp_hardenedbeacon_medium");
		} else if (isHigh()) {
			return Global.getSettings().getSpriteName("intel", "dcp_hardenedbeacon_high");
		}
		return Global.getSettings().getSpriteName("intel", "dcp_hardenedbeacon_low");
	}
    ...
    public Set<String> getIntelTags(SectorMapAPI map) {
        ...
        tags.add(dcp_Tags.BREAKER_FACTION);
        return tags;
    }
