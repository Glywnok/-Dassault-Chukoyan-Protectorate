...
public class dcp_PulseripperSmallOnHit extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
	...
	public dcp_PulseripperSmallOnHit() {
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		dcp_PulseripperSmallOnHit effect = new dcp_PulseripperSmallOnHit(projectile, (ShipAPI) target, offset);
	...
	public dcp_PulseripperSmallOnHit(DamagingProjectileAPI proj, ShipAPI target, Vector2f offset) {
		this.proj = proj;
		this.target = target;
		this.offset = offset;
