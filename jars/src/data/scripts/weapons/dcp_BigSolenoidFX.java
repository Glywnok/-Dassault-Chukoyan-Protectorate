 ...
 */
public class dcp_BigSolenoidFX implements EveryFrameWeaponEffectPlugin {
    ...
    private static final float OFFSET = 29f;
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (weapon.isFiring()) {
            ...
            if (elapsed <= 0f) {
                ...
                engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, 52f, 0.15f);
            }
            ...
            int particle_count_this_frame = (int) (18f * (FIRE_DURATION - elapsed));
            for (int x = 0; x < particle_count_this_frame; x++) {
                size = MagellanUtils.get_random(3f, 6f);
                speed = MagellanUtils.get_random(100f, 150f);
