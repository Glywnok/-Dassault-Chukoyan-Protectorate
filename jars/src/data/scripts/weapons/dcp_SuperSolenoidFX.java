 ...
 */
public class dcp_SuperSolenoidFX implements EveryFrameWeaponEffectPlugin {
    
    private static final float OFFSET = 60f; // Offset on weapon sprite; shoud be set to turret offset
...
//            }
            ...
            if (weapon_ammo < last_weapon_ammo) {
                ...
                engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, 60f, 0.25f);
