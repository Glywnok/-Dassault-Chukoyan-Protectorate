 ...
 */
public class dcp_HESniperFX implements EveryFrameWeaponEffectPlugin {
    ...
    private static final float OFFSET = 31f;
    private static final Color PARTICLE_COLOR = new Color(255,225,165,155); // Particle color
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (weapon.isFiring()) {
            ...
            if (elapsed <= 0f) {
                ...
                engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, 24f, 0.2f);
            }
            ...
            for (int x = 0; x < particle_count_this_frame; x++) {
                ...
                speed = MagellanUtils.get_random(30f, 150f);
                angle = weapon.getCurrAngle() + MagellanUtils.get_random(-4f, 4f);
