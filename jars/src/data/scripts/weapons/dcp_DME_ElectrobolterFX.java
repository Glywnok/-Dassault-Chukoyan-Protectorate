...
public class dcp_DME_ElectrobolterFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
   ...
   public void onFire(DamagingProjectileAPI proj, WeaponAPI weapon, CombatEngineAPI engine) {
      ...
      Vector2f explosion_offset = DMEUtils.translate_polar(weapon_location, 35.0F, weapon.getCurrAngle());
      Vector2f explosion_offset2 = DMEUtils.translate_polar(weapon_location, 31.0F, weapon.getCurrAngle());
