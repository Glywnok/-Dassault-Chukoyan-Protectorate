 ...
 */
public class dcp_LilSolenoidFX implements EveryFrameWeaponEffectPlugin {
    
    private static final float FIRE_DURATION = 0.16f; // Firing cycle time
    private static final Color FLASH_COLOR = new Color(200,200,255,155);
    private static final float OFFSET = 22f;
    private static final Color PARTICLE_COLOR = new Color(200,200,255,155); // Particle color
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (weapon.isFiring()) {
            ...
            if (elapsed <= 0f) {
                ...
                engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, 25f, 0.18f);
            }
            ...
            for (int x = 0; x < particle_count_this_frame; x++) {
                ...
                speed = DMEUtils.get_random(50f, 100f);
