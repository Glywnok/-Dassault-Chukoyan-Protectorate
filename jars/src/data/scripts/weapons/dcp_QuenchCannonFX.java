 ...
 */
public class dcp_QuenchCannonFX implements EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (weapon.isFiring()) {
            ...
            if (elapsed <= 0f) {
                ...
                engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, 60f, 0.21f);
            }
            ...
            for (int x = 0; x < particle_count_this_frame; x++) {
                ...
                speed = MagellanUtils.get_random(140f, 225f);
                angle = weapon.getCurrAngle() + MagellanUtils.get_random(-80f, 80f);
