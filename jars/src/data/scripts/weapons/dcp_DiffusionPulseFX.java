 ...
 */
public class dcp_DiffusionPulseFX implements EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (weapon.isFiring()) {
            ...
            if (elapsed <= 0f) {
                ...
                engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, 36f, 0.07f);
            }
            ...
            int particle_count_this_frame = (int) (16f * (FIRE_DURATION - elapsed));
            for (int x = 0; x < particle_count_this_frame; x++) {
                size = MagellanUtils.get_random(3f, 6f);
                speed = MagellanUtils.get_random(75f, 125f);
