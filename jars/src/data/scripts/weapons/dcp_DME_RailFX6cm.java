...
public class dcp_DME_RailFX6cm implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
   ...
   public void onFire(DamagingProjectileAPI proj, WeaponAPI weapon, CombatEngineAPI engine) {
      ...
      engine.spawnExplosion(proj_location, ship_velocity, FLASH_COLOR, 12.0F, 0.12F);
   }
