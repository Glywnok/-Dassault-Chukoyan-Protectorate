...
import static data.scripts.weapons.dcp_MinirailOnHit.DAMAGE_MINRADIUS;

import org.lwjgl.util.vector.Vector2f;

import java.awt.Color;

public class dcp_PhaseRailOnHit implements OnHitEffectPlugin
{
    ...
    public DamagingExplosionSpec createExplosionSpec() {
        ...
        spec.setSoundSetId("dcp_shockarty_crit");
        return spec;		
    }
}
