...
public class dcp_GradMissileAI extends dcp_BaseMissile
{
    ...
    private static final String STAGE_TWO_WEAPON_ID = "dcp_TBM_subForAI";
    ...
    public dcp_GradMissileAI(MissileAPI missile, ShipAPI launchingShip)
    {
