...
public class dcp_DME_PhasedBusterLauncherFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
   ...
   public void onFire(DamagingProjectileAPI proj, WeaponAPI weapon, CombatEngineAPI engine) {
      ...
      engine.addSwirlyNebulaParticle(explosion_offset, ship_velocity, NEBULA_SIZE, 15.0F, 0.1F, 0.2F, 0.6F, NEBULA_COLOR, true);
      engine.addSmoothParticle(explosion_offset, ship_velocity, NEBULA_SIZE * 4.0F, 0.75F, 0.1F, 0.15F, BOOM_COLOR);
      engine.spawnExplosion(explosion_offset, ship_velocity, BOOM_COLOR, NEBULA_SIZE * 6.0F, 0.3F);
   }
