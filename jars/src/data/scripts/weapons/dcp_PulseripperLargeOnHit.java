...
public class dcp_PulseripperLargeOnHit extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
	...
	public dcp_PulseripperLargeOnHit() {
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		dcp_PulseripperLargeOnHit effect = new dcp_PulseripperLargeOnHit(projectile, (ShipAPI) target, offset);
	...
	public dcp_PulseripperLargeOnHit(DamagingProjectileAPI proj, ShipAPI target, Vector2f offset) {
		this.proj = proj;
		this.target = target;
		this.offset = offset;
