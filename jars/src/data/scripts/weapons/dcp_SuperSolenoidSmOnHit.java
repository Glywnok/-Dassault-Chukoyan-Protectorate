...
public class dcp_SuperSolenoidSmOnHit implements OnHitEffectPlugin {

    private static final int MIN_ARCS = 1;
    private static final int MAX_ARCS = 2;
    ...
    private static final float FLUXRAISE = 200f;
    ...
    private static final float EXPLOSION_DURATION = 0.12f;
