...
public class dcp_BonecrusherOnHit implements OnHitEffectPlugin
{
    ...
    private static final int EXPLOSION_DAMAGE_MAX = 50;
    ...
    // fringe color
    private static final Color ARC_FRINGE_COLOR = new Color(255,235,200,155);
    // core color
    private static final Color ARC_CORE_COLOR = new Color(255,235,200,255);
