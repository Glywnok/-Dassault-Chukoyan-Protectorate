...
public class dcp_magellan_IonChargeFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
   ...
   public void onFire(DamagingProjectileAPI proj, WeaponAPI weapon, CombatEngineAPI engine) {
      ...
      Vector2f explosion_offset = DCPUtils.translate_polar(weapon_location, 18.0F, weapon.getCurrAngle());
      Vector2f explosion_offset2 = DCPUtils.translate_polar(weapon_location, 14.0F, weapon.getCurrAngle());
