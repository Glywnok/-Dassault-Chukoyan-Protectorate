...
public class dcp_magellan_BonegrinderOnHit implements OnHitEffectPlugin {
   ...
   private static final String SFX = "dcp_magellan_bonesaw_ftr_crit";
   ...
   public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
      if (!shieldHit && !projectile.isFading() && target instanceof ShipAPI) {
         ...
         Global.getSoundPlayer().playSound("dcp_magellan_bonesaw_ftr_crit", 1.0F, 1.0F, loc_target, v_target);
      }
