...
public class dcp_PulseripperFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
    ...
    public static final String REPLACE_WPN_ID = "dcp_pulseripper_large";
    //Muzzle flash
