...
public class dcp_DME_MatadorOnHit implements OnHitEffectPlugin {
   ...
   public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
      engine.spawnExplosion(point, target.getVelocity(), EXPLOSION_COLOR, 15.0F, 0.15F);
      ...
      for(int i = 0; i <= 1; ++i) {
         ...
         engine.addHitParticle(point, vector, 5.0F, 255.0F, 0.6F, PARTICLE_COLOR);
      }
