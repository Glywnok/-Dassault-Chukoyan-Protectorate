...
public class dcp_JackalSparks implements OnHitEffectPlugin
{
    //Armor/hull AoE
            ...
            CombatEngineAPI engine)
    {
                ...
                && Math.random() <= SPARK_CHANCE)
        {
    		...
    		engine.spawnProjectile(projectile.getSource(), projectile.getWeapon(), "dcp_jackal_sub", spawn, newangle, new Vector2f());
            }
            //play a sound
