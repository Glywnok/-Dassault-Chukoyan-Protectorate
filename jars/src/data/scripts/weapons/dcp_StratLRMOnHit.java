...
public class dcp_StratLRMOnHit implements OnHitEffectPlugin
{
    ...
    private static final int EXPLOSION_DAMAGE_MIN = 50;
    private static final int EXPLOSION_DAMAGE_MAX = 200;
    // amount of EMP damage dealt by the explosion
    private static final float CRIT_CHANCE = 1f;

    // -- explosion graphics -------------------------------------------------
    // color of the explosion
    private static final Color EXPLOSION_COLOR = new Color(255,165,50,155);
