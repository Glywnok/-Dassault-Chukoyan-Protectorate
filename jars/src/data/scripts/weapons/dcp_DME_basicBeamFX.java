...
public class dcp_DME_basicBeamFX implements EveryFrameWeaponEffectPlugin {
   private static final float FIRE_DURATION = 0.15F;
   private static final Color FLASH_COLOR = new Color(100, 100, 100, 255);
   private static final float OFFSET = 12.0F;
   private static final Color PARTICLE_COLOR = new Color(100, 100, 100, 255);
