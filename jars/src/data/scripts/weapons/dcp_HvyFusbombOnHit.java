...
public class dcp_HvyFusbombOnHit implements OnHitEffectPlugin
{
    ...
    private static final Color EXPLOSION_COLOR = new Color(240,100,125,255);

    // placeholder, please change this once you have a nice explosion sound :)
    private static final String SFX = "magellan_fusion_crit";
            ...
            CombatEngineAPI engine)
    {
        ...
        if (target instanceof ShipAPI && !shieldHit)
        {
            ...
            engine.spawnExplosion(point, v_target,
                    ...
                    180f, // sets the size of the explosion
                    0.75f // how long the explosion lingers for
            );
            //play a sound
