...
public class dcp_DME_LinearFlakFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
   private static final Color FLASH_COLOR = new Color(255, 155, 75, 225);
   ...
   public void onFire(DamagingProjectileAPI proj, WeaponAPI weapon, CombatEngineAPI engine) {
      ...
      for(int j = 0; j < shotCount; ++j) {
         ...
         engine.spawnProjectile(proj.getSource(), proj.getWeapon(), "dcp_DME_linearflakshot_clone", loc, proj.getFacing(), ship_velocity);
      }
      ...
      engine.spawnExplosion(proj_location, ship_velocity, FLASH_COLOR, 4.0F, 0.2F);
   }
