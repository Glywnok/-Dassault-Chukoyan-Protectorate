 ...
 */
public class dcp_HEShotgunFX implements EveryFrameWeaponEffectPlugin {
    
    private static final float FIRE_DURATION = 0.21f; // Firing cycle time
    private static final Color FLASH_COLOR = new Color(255,225,165,175);
    private static final float OFFSET = 27f;
    private static final Color PARTICLE_COLOR = new Color(255,225,165,175); // Particle color
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (weapon.isFiring()) {
            ...
            if (elapsed <= 0f) {
                ...
                engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, 32f, 0.24f);
            }
            ...
            for (int x = 0; x < particle_count_this_frame; x++) {
                ...
                speed = MagellanUtils.get_random(15f, 120f);
                angle = weapon.getCurrAngle() + MagellanUtils.get_random(-15f, 15f);
