 ...
 */
public class dcp_QuenchGunFX implements EveryFrameWeaponEffectPlugin {
    
    private static final float FIRE_DURATION = 0.135f; // Firing cycle time
    private static final Color FLASH_COLOR = new Color(200,200,255,155);
    private static final float OFFSET = 32f;
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (weapon.isFiring()) {
            ...
            if (elapsed <= 0f) {
                ...
                engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, 36f, 0.18f);
            }
            ...
            for (int x = 0; x < particle_count_this_frame; x++) {
                ...
                speed = MagellanUtils.get_random(125f, 200f);
