...
public class dcp_DME_ElecRocketSmLaunchFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
   ...
   public void onFire(DamagingProjectileAPI proj, WeaponAPI weapon, CombatEngineAPI engine) {
      ...
      engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, 32.0F, 0.1F);
   }
