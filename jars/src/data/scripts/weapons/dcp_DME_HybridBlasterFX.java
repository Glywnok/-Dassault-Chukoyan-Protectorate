...
public class dcp_DME_HybridBlasterFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
   ...
   public void onFire(DamagingProjectileAPI proj, WeaponAPI weapon, CombatEngineAPI engine) {
      ...
      engine.spawnExplosion(proj_location, ship_velocity, FLASH_COLOR, 50.0F, 0.2F);
   }
