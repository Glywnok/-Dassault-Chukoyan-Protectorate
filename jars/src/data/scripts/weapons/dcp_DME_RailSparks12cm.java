...
public class dcp_DME_RailSparks12cm implements OnHitEffectPlugin {
   ...
   private static final String SFX = "dcp_DME_rail_crit_12cm";
   ...
   public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
      if (target instanceof ShipAPI && !shieldHit) {
         ...
         for(int i = 1; i <= 5; ++i) {
            ...
            engine.addHitParticle(point, vector, 5.0F, 255.0F, 2.4F, BRIGHT_COLOR);
            engine.addHitParticle(point, vector, 20.0F, 255.0F, 1.2F, DIM_COLOR);
            Global.getSoundPlayer().playSound("dcp_DME_rail_crit_12cm", 1.0F, 1.0F, target.getLocation(), target.getVelocity());
         }
      }
