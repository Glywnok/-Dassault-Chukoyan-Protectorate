...
public class dcp_JackalLgSparks implements OnHitEffectPlugin
{
    //Armor/hull AoE
    ...
    private static final String SFX = "dcp_jackal_crit";
    // -- particle geometry --------------------------------------------------
            ...
            CombatEngineAPI engine)
    {
                ...
                && Math.random() <= SPARK_CHANCE)
        {
    		...
    		engine.spawnProjectile(projectile.getSource(), projectile.getWeapon(), "dcp_twinjack_sub", spawn, newangle, new Vector2f());
            }
            //play a sound
    ...
    public DamagingExplosionSpec createExplosionSpec() {
        ...
        spec.setSoundSetId("dcp_ballistic_crit");
        return spec;		
    }
}
