 ...
 */
public class dcp_RipfireMedLaunchFX implements EveryFrameWeaponEffectPlugin {
    
    private static final float OFFSET = 12f; // Offset on weapon sprite; shoud be set to turret offset
    private static final Color FLASH_COLOR = new Color(225,225,200,255); //Color of muzzle flash explosion
    private static final float FLASH_SIZE = 32f; //Size of muzzle flash explosion
...
//            }
            ...
            if (weapon_ammo < last_weapon_ammo) {
                ...
                engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, FLASH_SIZE, 0.07f);
