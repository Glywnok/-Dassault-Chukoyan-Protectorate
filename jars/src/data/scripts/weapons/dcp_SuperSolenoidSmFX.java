 ...
 */
public class dcp_SuperSolenoidSmFX implements EveryFrameWeaponEffectPlugin {
    
    private static final float OFFSET = 29f; // Offset on weapon sprite; shoud be set to turret offset
    private static final Color FLASH_COLOR = new Color(200,200,255,155); //Color of muzzle flash explosion
...
//            }
            ...
            if (weapon_ammo < last_weapon_ammo) {
                ...
                engine.spawnExplosion(explosion_offset, ship.getVelocity(), FLASH_COLOR, 32f, 0.2f);

                //add particle burst here at some point
            }
        }
