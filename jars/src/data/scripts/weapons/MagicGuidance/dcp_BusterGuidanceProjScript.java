...
public class dcp_BusterGuidanceProjScript extends BaseEveryFrameCombatPlugin {
	 ...
	 */
	public dcp_BusterGuidanceProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
