...
public class dcp_MortarGuidanceProjScript extends BaseEveryFrameCombatPlugin {
	 ...
	 */
	public dcp_MortarGuidanceProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
