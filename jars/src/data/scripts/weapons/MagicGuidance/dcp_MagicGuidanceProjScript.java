...
public class dcp_MagicGuidanceProjScript extends BaseEveryFrameCombatPlugin {
	 ...
	 */
	public dcp_MagicGuidanceProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
