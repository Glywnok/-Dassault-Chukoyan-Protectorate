...
public class dcp_ADSMissileGuidanceProjScript extends BaseEveryFrameCombatPlugin {
	 ...
	 */
	public dcp_ADSMissileGuidanceProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
