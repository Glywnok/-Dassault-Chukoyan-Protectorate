...
public class dcp_JavelotGuidanceProjScript extends BaseEveryFrameCombatPlugin {
	 ...
	 */
	public dcp_JavelotGuidanceProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
