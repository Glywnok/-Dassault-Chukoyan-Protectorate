...
public class dcp_LinearFlakFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
    ...
    public void onFire(DamagingProjectileAPI proj, WeaponAPI weapon, CombatEngineAPI engine)
    {
        ...
        for (int j = 0; j < shotCount; j++) {
            ...
            engine.spawnProjectile(proj.getSource(), proj.getWeapon(), "dcp_linearflakshot_clone", loc, proj.getFacing(),
                                   randomVel);
        }
