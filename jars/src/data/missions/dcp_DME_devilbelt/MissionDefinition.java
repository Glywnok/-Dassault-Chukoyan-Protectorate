...
public class MissionDefinition implements MissionDefinitionPlugin {
   public void defineMission(MissionDefinitionAPI api) {
      ...
      api.addToFleet(FleetSide.PLAYER, "istl_wanderer_std", FleetMemberType.SHIP, false).getCaptain().setPersonality("aggressive");
      api.addToFleet(FleetSide.PLAYER, "istl_naja_export", FleetMemberType.SHIP, false).getCaptain().setPersonality("steady");
      api.addToFleet(FleetSide.PLAYER, "istl_sevastopol_std", FleetMemberType.SHIP, "SS Just A Working Girl", false).getCaptain().setPersonality("cautious");
      api.addToFleet(FleetSide.PLAYER, "istl_centaur_export", FleetMemberType.SHIP, false).getCaptain().setPersonality("steady");
      api.addToFleet(FleetSide.PLAYER, "istl_puddlejumper_export", FleetMemberType.SHIP, false).getCaptain().setPersonality("timid");
      api.addToFleet(FleetSide.PLAYER, "istl_puddlejumper_export", FleetMemberType.SHIP, false).getCaptain().setPersonality("timid");
      api.addToFleet(FleetSide.PLAYER, "istl_puddlejumper_export", FleetMemberType.SHIP, false).getCaptain().setPersonality("timid");
      api.addToFleet(FleetSide.PLAYER, "istl_puddlejumper_export", FleetMemberType.SHIP, false).getCaptain().setPersonality("timid");
      ...
      api.addToFleet(FleetSide.ENEMY, "istl_imp_assault", FleetMemberType.SHIP, false).getCaptain().setPersonality("reckless");
      api.addToFleet(FleetSide.ENEMY, "istl_imp_assault", FleetMemberType.SHIP, false).getCaptain().setPersonality("reckless");
      api.addToFleet(FleetSide.ENEMY, "istl_imp_support", FleetMemberType.SHIP, false).getCaptain().setPersonality("aggressive");
      api.addToFleet(FleetSide.ENEMY, "istl_imp_support", FleetMemberType.SHIP, false).getCaptain().setPersonality("aggressive");
