...
public class dcp_DME_SigmaMineStrikeStats extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
   public static float MINE_RANGE = 1000.0F;
   public static final float MIN_SPAWN_DIST = 30.0F;
   ...
   public void spawnMine(ShipAPI source, Vector2f mineLoc) {
      ...
      MissileAPI mine = (MissileAPI)engine.spawnProjectile(source, (WeaponAPI)null, "dcp_DME_sigma_minelayer", currLoc, (float)Math.random() * 360.0F, (Vector2f)null);
      ...
      return new BaseEveryFrameCombatPlugin() {
         ...
         public void advance(float amount, List<InputEventAPI> events) {
            if (!Global.getCombatEngine().isPaused()) {
               ...
               Color c = data.shipsystems.scripts.dcp_DME_SigmaMineStrikeStats.JITTER_UNDER_COLOR;
   ...
   private boolean isLocationClear(Vector2f loc) {
      ...
      do {
         ...
         dist = Misc.getDistance(loc, other.getLocation());
      } while(!(dist < other.getCollisionRadius() + 30.0F));
