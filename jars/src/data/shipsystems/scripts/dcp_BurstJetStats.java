...
public class dcp_BurstJetStats extends BaseShipSystemScript {

    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        if (state == ShipSystemStatsScript.State.OUT) {
            stats.getMaxSpeed().modifyPercent(id, 200f * effectLevel); // to slow down ship to its regular top speed while powering drive down
            ...
            stats.getMaxSpeed().modifyPercent(id, 25f * effectLevel);
