...
public class dcp_People extends People {
        //Faction leader
        ...
        //Cousteau Base (later)
//        public static final String DME_BLANK = "dcp_blank_id";
//        public static final String DME_BLANK = "dcp_blank_id";
        //spaaaaace asshoooo-ooles, spaaace asshoooo-ooles...
//        public static final String BREAKER_DESERTER = "dcp_breaker_deserter";
//        public static final String BREAKER_LEADER = "dcp_breaker_leader";
//        public static final String BREAKER_NIKO = "dcp_breaker_niko"; //the boy has crossed a line
...
//        public static final String DME_BLANK = "dcp_blank_id";
    ...
    public static void createFactionLeaders() {
        ...
        market =  Global.getSector().getEconomy().getMarket("dcp_planet_peremohy");
        if (market != null) {
                PersonAPI person = Global.getFactory().createPerson();
		person.setId(DME_ARI);
                person.setFaction(dcp_Factions.DASSAULT);
    ...
    public static void createLavoisierBaseCharacters() {
		...
		person.setId(DME_EMILE);
                ...
                person.setRankId(dcp_Ranks.SMATTER_RESEARCHER);
        ...
        if (market != null) {
                PersonAPI person = Global.getSector().getFaction(dcp_Factions.DASSAULT).createRandomPerson();
		person.setId(DME_ARMSDEV);
                person.setRankId(Ranks.CITIZEN);
                person.setPostId(dcp_Ranks.POST_ARMS_RESEARCHER);
    ...
    public static void createLaReoleCharacters() {
        final ImportantPeopleAPI ip = Global.getSector().getImportantPeople();
        MarketAPI market = null;
        market =  Global.getSector().getEconomy().getMarket("dcp_planet_lareole");
		...
		person.setId(DME_NIKO);
                ...
                person.setPostId(dcp_Ranks.POST_SNRI_REPRESENTATIVE);
                person.setImportance(PersonImportance.HIGH);
