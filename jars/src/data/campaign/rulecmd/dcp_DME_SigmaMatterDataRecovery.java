...
//        }
    ...
    protected boolean personCanAcceptSMatter() {
        ...
        return
           ...
           dcp_Ranks.SMATTER_RESEARCHER.equals(person.getRankId()) ||
           dcp_Ranks.POST_SNRI_REPRESENTATIVE.equals(person.getPostId());
    ...
    protected void selectSMatter() {
        ...
        for (CargoStackAPI stack : playerCargo.getStacksCopy()) {
            ...
            //if (spec != null && spec.getDemandClass().equals(dcp_Commodities.SIGMA_MATTER)) {
...
protected float computeSMatterCreditValue(CargoAPI cargo) {
    ...
    public static float getBaseRepValue(String dcp_SigmaMatterType) {
        if (dcp_Commodities.SIGMA_MATTER_HIGH.equals(dcp_SigmaMatterType)) {
            return 7f;
        }

        if (dcp_Commodities.SIGMA_MATTER_LOW.equals(dcp_SigmaMatterType)) {
            return 5f;    
        }
        if (dcp_Commodities.SIGMA_MATTER_UNSTABLE.equals(dcp_SigmaMatterType)) {
                return 2f;
        }
        return 1f;
    }
